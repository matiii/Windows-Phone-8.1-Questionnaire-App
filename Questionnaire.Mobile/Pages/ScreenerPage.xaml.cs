...
namespace Questionnaire.Mobile.Pages
{
    ...
    /// </summary>
    public sealed partial class ScreenerPage : Page
    {
        ...
        {
            if (e.Parameter != null && e.Parameter is bool) //is from save
            {
        ...
        private void GoNext_OnClick(object sender, RoutedEventArgs e)
        {
            ...
            var screener = new Screener {Event = model.Event, Name = model.Name};
